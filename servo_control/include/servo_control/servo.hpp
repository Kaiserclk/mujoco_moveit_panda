...
public:
   ...
   * @return 伺服参数
   */
  servo_control::Params& getParams();
...
private:
   ...
   */
  bool validateParams(const servo_control::Params& servo_params);
  ...
  std::shared_ptr<const servo_control::ParamListener> servo_param_listener_;
